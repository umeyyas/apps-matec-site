...
<head>
    <title>Welcome to MATEC2025 :: MARA AUTOMOTIVE ECO-SYSTEMS 2025</title>
            ...
            <div class="col-md-3 mb-sm-0 mb-60">
                <div class="card" style="background-image: url(<?= asset('images/2025/bg-exhibitor1820.webp') ?>)">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-7 order-2 order-sm-1">
                                <img src="<?= asset('images/2025/event_layout_icon.png') ?>" alt="" class="img-fluid newtab" data-pdf-url="<?= asset('images/2025/map_ori_v2_04.png') ?>" >
                            </div>
