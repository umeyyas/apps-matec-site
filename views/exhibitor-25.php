                ...
                <div class="card" style="background-image: url(<?= asset('images/2025/bg-exhibitor1820.webp') ?>)">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12 col-5 pl-sm-2 pl-0 text-center order-1 order-sm-2 py-sm-auto d-flex align-items-center justify-content-center pt-sm-0 pt-10">
            ...
            <div class="col-md-3 mb-sm-0 mb-60">
                <div class="card" style="background-image: url(<?= asset('images/2025/bg-exhibitor1820.webp') ?>)">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-7 order-2 order-sm-1">
                                <img src="<?= asset('images/2025/partnership_icon.png') ?>" alt="" class="img-fluid newtab" data-pdf-url="" >
                                <!-- <?= asset('pdf/MATEC2024_Event Brief_v7 14082024.pdf') ?> -->
                            </div>
                            <div class="col-md-12 col-5 pl-sm-2 pl-0 text-center order-1 order-sm-2 d-flex align-items-center justify-content-center pt-sm-0 pt-10">
            ...
            <div class="col-md-3 mb-sm-0 mb-60">
                <div class="card" style="background-image: url(<?= asset('images/2025/bg-exhibitor1820.webp') ?>)">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-7 order-2 order-sm-1">
                                <img src="<?= asset('images/2025/event_layout_icon.png') ?>" alt="" class="img-fluid newtab" data-pdf-url="<?= asset('images/2025/map_ori_v1_04.png') ?>" >
                            </div>
                            <div class="col-md-12 col-5 pl-sm-2 pl-0 text-center order-1 order-sm-2 d-flex align-items-center justify-content-center pt-sm-0 pt-10">
